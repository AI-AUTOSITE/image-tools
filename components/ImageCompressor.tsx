// ===================================
// 2. components/ImageCompressor.tsx - メインコンポーネント
// ===================================
'use client'
        ...
        {isDragActive ? (
          ...
          <>
            ...
            <p className="text-xs text-gray-400 mt-2">
              JPG, PNG, WebP, GIF, BMP supported • No file size limits
            </p>
          </>
        )}
      </div>
      ...
      {images.length === 0 && (
        <div className="mt-12 grid grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="font-medium text-gray-900 mb-1">No Limits</h3>
            <p className="text-sm text-gray-500">Unlimited files & size</p>
          </div>
          <div className="text-center">
